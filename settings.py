...
FALLLING_SPEED = 1 #The speed at which the player falls in pixels per frame
PLAYER_GRAVITY_PULL_DELAY = max(1, 1 * (MAX_FPS // 30)) #The delay in frames between gravity pulls
BASE_GRAVITY_PULL = FALLLING_SPEED #The base gravity pull any entity with simulated physics
MAX_FALL_SPEED = min(FALLLING_SPEED * 16, 32) #The maximum speed the player can fall at in pixels per frame (should be multiple of FALLING_SPEED)
